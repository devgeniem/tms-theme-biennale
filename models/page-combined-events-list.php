...
class PageCombinedEventsList extends PageEventsSearch {
    ...
    public function filter_strings() : array {
        $strings = [
            'day'          => \__( 'Filter by day', 'tms-theme-biennale' ),
            'change_order' => \__( 'Change order', 'tms-theme-biennale' ),
            'order'        => \__( 'Order:', 'tms-theme-biennale' ),
        ];
    ...
    public function days() {
        ...
        $choices[] = [
            'label'       => \__( 'All days', 'tms-theme-biennale' ),
            'value'       => '',
    ...
    public function event_order() {
        ...
        $choices = [
            [
                ...
                'label'       => \__( 'Date', 'tms-theme-biennale' ),
            ],
            [
                'value'       => 'title',
                'is_selected' => 'title' === $selected_order ? 'selected' : '',
                'label'       => \__( 'Alphabetical', 'tms-theme-biennale' ),
            ],
        ];
