    ...
    public function event() {
        ...
        if ( ! empty( $event->event_custom_spotify_embed ) ) {
            ...
            $placeholder = sprintf(
                ...
                \__( 'Please <a href="%1$s" class="cookiebot-helper__link">accept marketing cookies</a> to view the embed.', 'tms-theme-biennale' ),
                $renew_url
            );
        ...
        return [
            ...
            'orig'                     => $event,
            'buy_ticket_string'        => \__( 'Buy ticket', 'tms-theme-biennale' ),
            'time_prefix'              => \__( 'at', 'tms-theme-biennale' ),
            'artists_title'            => \__( 'Artists', 'tms-theme-biennale' ),
            'compositions_title'       => \__( 'Compositions', 'tms-theme-biennale' ),
            'creative_team_title'      => \__( 'Creative team', 'tms-theme-biennale' ),
