...
namespace TMS\Theme\Biennale\ACF;
...
class AlterManualEventGroup {
    ...
    public function add_event_fields( $fields ) {
        ...
        try {
            ...
            $event_subheading_field = ( new Field\Text( $strings['subheading']['label'] ) )
                ->set_key( 'fg_manual_event_fields_event_custom_subheading' )
                ->set_name( 'event_custom_subheading' )
                ->set_instructions( $strings['subheading']['instructions'] );
            ...
            $event_artists_field = ( new Field\Wysiwyg( $strings['artists']['label'] ) )
            ...
            $event_creative_team_field = ( new Field\Wysiwyg( $strings['creative_team']['label'] ) )
                ...
                ->set_name( 'event_custom_creative_team' )
                ->set_toolbar( [ 'bold', 'italic', 'link' ] )
                ->disable_media_upload()
                ->set_instructions( $strings['creative_team']['instructions'] );
            ...
            $event_artists_link_list_field = new SomeLinkListFields(
                'Esiintyjien linkit',
                'fg_manual_event_fields_event_custom_artists_link_list',
                'event_custom_artists_link_list'
            );

            $event_composers_link_list_field = new SomeLinkListFields(
                'Säveltäjien linkit',
                'fg_manual_event_fields_event_custom_composers_link_list',
