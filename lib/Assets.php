...
class Assets extends \TMS\Theme\Base\Assets implements \TMS\Theme\Base\Interfaces\Controller {
    ...
    public function hooks(): void {
        ...
        \add_filter( 'tms/theme/asset_mod_time', function ( $mod_time, $filename ) {
            if ( false !== strpos( $filename, 'biennale' ) ) {
        ...
        \add_action(
            'wp_footer',
            \Closure::fromCallable( [ $this, 'include_biennale_svg_icons' ] )
        );
     ...
     */
    private function include_biennale_svg_icons(): void {
        $svg_icons_path = \get_stylesheet_directory() . '/assets/dist/icons-biennale.svg';
